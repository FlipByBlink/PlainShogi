...
struct 📬盤上ドロップ: DropDelegate {
    ...
    init(_ ⓐppModel: 📱AppModel, _ ｲﾁ: Int, _ 成り駒アラートを表示: Binding<Bool>) {
        (📱, self.位置, self._🚩成り駒アラートを表示) = (ⓐppModel, ｲﾁ, 成り駒アラートを表示)
    }
}
